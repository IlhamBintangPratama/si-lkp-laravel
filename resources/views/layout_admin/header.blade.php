<header class="bg-nav">
    <div class="flex justify-between">
        ...
        <div class="p-1 flex flex-row items-center">
            ...
            <div id="ProfileDropDown" class="rounded hidden shadow-md bg-white absolute pin-t pin-r" style="margin-top: 9rem; width: 8rem; margin-left: -2%; background-color: #3F495E;">
                <ul class="list-reset">
                  <li><a href="{{ url('account')}}" class="no-underline px-4 py-2 block text-white hover:bg-gray-700">My account</a></li>
