...
<div class="p-8 rounded border border-gray-200">
    <h1 class="font-medium text-3xl">Tambah User</h1>
    ...
    <form method="Post" action="{{ url('m_user') }}" name="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="mt-8 space-y-6">
            <div>
                <label for="nama" class="text-sm text-gray-700 block mb-1 font-medium">Nama</label>
                <input type="text" name="nama" id="nama" autocomplete="off" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block 
            ...
            <div>
                ...
                <input type="text" name="email" id="email" autocomplete="off" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block 
                focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" required />
            </div><br>
            <div>
            ...
            <div class="relative">
                ...
                <select class="form-control block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey"
