...
<div class="p-8 rounded border border-gray-200">
    <h1 class="font-medium text-3xl">Edit User</h1>
    ...
    <form method="Post" action="{{ url('/m_user/'.$user->id.'/update') }}" name="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="mt-8 space-y-6">
            ...
            focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" value="{{ old('name', $user->name) }}" required />
            </div><br>
            ...
            focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" value="{{ old('name', $user->email) }}" required />
            </div>
        </div>
