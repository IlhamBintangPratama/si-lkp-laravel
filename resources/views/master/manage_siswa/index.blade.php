            ...
            <table class="table-responsive w-full rounded">
                <thead>
                    <tr>
                        ...
                        <th class="border px-4 py-2" style="width: 47.5%">Jumlah Siswa</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <a class="bg-teal-300 hover:bg-teal-400 cursor-pointer rounded p-2 mx-1 text-white" href="{{ url('/k_siswa/'.$s->id.'/show') }}">
