    ...
    <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
        ...
        <div class="p-3">
            <div class="mb-3">
                ...
                <a class="bg-teal-300 hover:bg-teal-400 right-0 py-2 px-3 text-white rounded-lg float-left mb-3" href="{{ url('/k_siswa/'.$k->id_kelas.'/create') }}">
            ...
            <table class="table-responsive w-full rounded">
                <thead>
                    <tr>
                        ...
                        <th class="border px-4 py-2" style="width: 44.5%">Nama Pendidik</th>
                        <th class="border px-4 py-2" style="width: 44.5%">Nama Siswa</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $s->lskelas->nama }}</td>
                        <td class="border px-4 py-2">{{ $s->siskelas->nama }}</td>
...
<script>
    ...
    function openModal(id){
        ...
        form.action = `{{url('k_siswa/${id}/destroy')}}`
    }
</script>
@endsection