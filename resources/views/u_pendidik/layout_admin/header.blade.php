<header class="bg-nav">
    <div class="flex justify-between">
        ...
        <div class="p-1 flex flex-row items-center">
            ...
            <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block">Pendidik</a>
            <div id="ProfileDropDown" class="rounded hidden shadow-md bg-white absolute pin-t pin-r" style="margin-top: 11rem; background-color: #3F495E;">
                <ul class="list-reset">
