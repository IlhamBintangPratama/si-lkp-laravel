...
<div class="p-8 rounded border border-gray-200">
    ...
    <form method="Post" action="{{ url('materi_video') }}" name="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="mt-8 space-y-6">
            ...
            <div>
                ...
                <input type="file" name="video" id="video" class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block 
                focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full" required />
            </div><br>
            <div>
