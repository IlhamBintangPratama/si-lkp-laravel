...
<div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
    <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
        ...
        <div class="p-3">
            <div class="mb-3">
                <a class="bg-teal-300 hover:bg-teal-400 right-0 py-2 px-3 text-white rounded-lg float-right mb-3" href="{{ url('/materi_video/create') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <a class="bg-teal-300 hover:bg-teal-400 cursor-pointer rounded p-2 mx-1 text-white" href="{{ url('/materi_video/'.$s->id.'/show') }}">
                                    <i class="fas fa-eye"></i></a>
                            {{-- <a class="bg-teal-300 hover:bg-teal-400 cursor-pointer rounded p-2 mx-1 text-white" href="{{ url('/materi_video/'.$s->id.'/edit') }}">
...
<script>
    ...
    function openModal(id){
        ...
        form.action = `{{url('materi_video/${id}/destroy')}}`
    }
</script>
@endsection