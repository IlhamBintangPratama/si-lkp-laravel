            ...
            <table class="table-responsive w-full rounded">
                <thead>
                    <tr>
                        ...
                        <th class="border px-4 py-2" style="width: 22%">Nama Siswa</th>
                        <th class="border px-4 py-2" style="width: 22%">Tema Praktek</th>
                        <th class="border px-4 py-2" style="width: 14%">Nilai Kreatif</th>
                        <th class="border px-4 py-2" style="width: 14%">Nilai Ketrampilan</th>
                        <th class="border px-4 py-2" style="width: 14%">Nilai Sikap</th>
