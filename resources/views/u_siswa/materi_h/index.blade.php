    ...
    <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
        ...
        <div class="p-3">
            ...
            <table class="table-responsive w-full rounded">
                ...
                <tbody>
                    @foreach ($m_harian as $no => $s)
                    <tr>
                        <td class="border px-4 py-2">{{ $m_harian->firstItem()+$no }}</td>
                        ...
                        <td class="border px-4 py-2">
                            <a class="bg-teal-300 hover:bg-teal-400 cursor-pointer rounded p-2 mx-1 text-white" href="{{ url('/mat_harian/'.$s->id.'/show') }}">
